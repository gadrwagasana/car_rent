        ...
        <div className=' mt-4 px-3 flex'>
            <div className=' w-1/2'>
                ...
                <div className=' mt-4 flex gap-4'>
                    ...
                    <Link href={"/car"} className={cn(Style_button() , " capitalize button-animation hover:bg-success bg-warning shadow-warning hover:shadow-success")} >All cars <GoArrowUpRight className='group-hover/account:scale-110 duration-300' size={20}/></Link>
                </div>
                {/* customer */}
            ...
            <div className=' w-1/2'>
                <div className=' w-full h-full relative'>
                    <Image src={bigImage} fill alt='images' priority className=' object-cover rounded-box'/>
                </div>
            </div>
        </div>
    </div>
